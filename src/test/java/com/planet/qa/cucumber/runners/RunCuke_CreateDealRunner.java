...
@CucumberOptions(features = { "src\\test\\resources\\features" }, glue = {
		"com.planet.qa.cucumber.steps" }, monochrome = true, tags = {
				"@smoke" }, plugin = { "pretty", "html:target/cucumber" })

public class RunCuke_CreateDealRunner extends AbstractTestNGCucumberTests {
	private TestNGCucumberRunner testngCucumberRunner;
	  ...
	  testngCucumberRunner = new TestNGCucumberRunner(this.getClass()); Object[][]
	  data = testngCucumberRunner.provideScenarios(); String featureName =
	  data[0][1].toString().replaceAll("^\"|\"$", "");
